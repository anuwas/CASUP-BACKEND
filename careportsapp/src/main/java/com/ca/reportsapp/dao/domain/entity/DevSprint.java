...
public class DevSprint implements Serializable{
	...
	private long scopeCreep;
	
	@Column(name = "scope_creep_description")
	private String scopeCreepDescription;
	
	@Column(name = "spill_over_sp")
	private long spillOverSp;
	
	@Column(name = "spill_over_item")
	private String spillOverItem;
	
	@Column(name = "is_spill_over")
