...
public class SupportItemController {
	...
	@GetMapping("/sup-active-item-list/{itemType}")
	public List<SupportItem> retriveActiveItemListByType(@PathVariable String itemType) {
		return supportItemService.getActiveItemListByType(itemType);
	}
