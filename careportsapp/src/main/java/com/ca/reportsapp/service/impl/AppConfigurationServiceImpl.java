...
import com.ca.reportsapp.dao.repository.AppConfigurationPropertiesRepository;
...
public class AppConfigurationServiceImpl implements AppConfigurationService{
	...
	@Autowired
	AppConfigurationPropertiesRepository appConfigurationPropertiesRepository;
	...
	@Override
	public List<AppConfigurationProperties> getAllConfiguratinProperties() {
		return (List<AppConfigurationProperties>) appConfigurationPropertiesRepository.findAll();
	}
